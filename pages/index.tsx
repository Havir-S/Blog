        ...
        <div className=" xl:max-w-7xl mx-auto xl:rounded-lg shadow-lg mt-5 flex flex-col md:flex-row text-center md:text-left py-6 md:py-10 md:px-10 justify-between items-center bg-gradient-to-r from-gray-900 via-slate-900 to-black   ">
          <div className="px-10 space-y-5">
            <h1 className=" text-3xl md:text-5xl xl:text-6xl max-w-xl font-serif text-white">
              <span className="underline decoration-white font-signika decoration-4">
                Hello and welcome to my blog
              </span>
            </h1>
            <h2 className="text-white text-xl font-prompt max-w-[600px]">
              I develop <span className="text-amber-400">websites</span>, edit
              videos and images, create 3d objects and work on{" "}
              <span className="text-amber-400">road design.</span>
            </h2>
            <h3 className="hidden md:block text-gray-300 text-sm font-prompt">
              Feel free to look around, perhaps You'll find something that
              catches your <span className="text-amber-400">attention!</span>
            </h3>
          </div>
          ...
          <div className="flex-grow ">
            <div className="grid  grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-3 md:gap-6 px-2 md:px-6">
              {posts.map((post) => {
                return (
                  <Link
                    className="bg-white border border-gray-200 group rounded-lg relative shadow-md"
                    key={post._id}
                    ...
                    <div className="border h-full rounded-lg group cursor-pointer overflow-hidden">
                      ...
                      <div className="flex justify-between p-5 bg-white">
                        <div className="w-full ">
                          ...
                          <p
                            className={`absolute left-2 top-2 font-bold shadow-xl ${post.type} text-white rounded-xl px-3 py-1 w-fit border opacity-90 transition duration-200 group-hover:opacity-100 `}
                          >
                            {post.type}
                          </p>
                          <p className="text-xl font-bold font-signika">
                            {post.title}
                          </p>
