...
const Header = ({ showReturn }: HeaderProps) => {
  return (
    // <header className='sticky top-0 bg-purple-900 border-purple-500 border-b-4 border-x border-x-transparent rounded-b-[25px]'>
        ...
        <div className='text-[#514538] border-b-4 border-[#514538] sticky h-20 top-0 z-10 text-xl flex justify-between  mx-auto bg-amber-500 bg-gradient-to-r from-amber-500 via-amber-500 to-amber-700'>
            <div className='max-w-7xl mx-auto flex items-center justify-between gap-3 w-full px-3'>
              <div className='flex justify-center items-center'>
                ...
                <Link href='/' className='font-prompt border-2 border-[#514538] font-bold px-4 py-1 rounded-full shadow-md hover:shadow-lg cursor-pointer transition duration-300 hover:scale-105 hover:border-white bg-transparent hover:text-white hover:bg-slate-900'>Visit portfolio</Link>
              </div>   
